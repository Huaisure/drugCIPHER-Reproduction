...
# TS matrix for test
# TS_matrix = np.array(cal_test_ts(test, test, counts_dict))
# np.save("TS_matrix.npy", TS_matrix)
...
for i in range(len(test)):
    ...
    ts_score_list.append(
        [
            abs(np.corrcoef(drugTS_list, target_closeness)[0, 1])
